...
export function activateA(context: vscode.ExtensionContext) {
	const disposable = vscode.Disposable.from(
		vscode.commands.registerCommand('error-recorder.pickString', pickString),
		vscode.commands.registerCommand('error-recorder.promptString', promptString),
	);
