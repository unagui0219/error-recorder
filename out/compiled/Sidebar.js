var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 54, 8, 1465);
    			add_location(button, file, 55, 8, 1487);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 45, 8, 1253);
    			add_location(button, file, 46, 8, 1275);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 22, 8, 620);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "errorを入力");
    			input.autofocus = true;
    			add_location(input, file, 24, 12, 682);
    			attr_dev(div0, "class", "search-input svelte-1xwqqky");
    			add_location(div0, file, 23, 8, 643);
    			add_location(button0, file, 27, 12, 798);
    			attr_dev(div1, "class", "sidebar-btn svelte-1xwqqky");
    			add_location(div1, file, 26, 8, 760);
    			add_location(button1, file, 36, 12, 1024);
    			attr_dev(div2, "class", "sidebar-btn svelte-1xwqqky");
    			add_location(div2, file, 35, 8, 986);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(22:4) {#if state.page === \\\"search\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*state*/ ctx[0].page === "search") return create_if_block;
    		if (/*state*/ ctx[0].page === "show") return create_if_block_1;
    		if (/*state*/ ctx[0].page === "edit") return create_if_block_2;
    	}
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			t = text("error recorder index\n    ");
    			if (if_block) if_block.c();
    			add_location(main, file, 19, 0, 546);
    		},
