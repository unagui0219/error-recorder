var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("保存する");
    			attr_dev(input0, "id", "error-title");
    			attr_dev(input0, "class", "post-input svelte-1285mui");
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*errorTitle*/ ctx[2]);
    			append_dev(form, t1);
    			append_dev(form, textarea0);
    			set_input_value(textarea0, /*errorSourceCode*/ ctx[3]);
    			append_dev(form, t2);
    			append_dev(form, textarea1);
    			set_input_value(textarea1, /*errorSolutionCode*/ ctx[4]);
    			append_dev(form, t3);
    			append_dev(form, input1);
    			set_input_value(input1, /*lang*/ ctx[5]);
    			append_dev(form, t4);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*errorTitle*/ 4 && input0.value !== /*errorTitle*/ ctx[2]) {
    				set_input_value(input0, /*errorTitle*/ ctx[2]);
    			}

    			if (dirty & /*errorSourceCode*/ 8) {
    				set_input_value(textarea0, /*errorSourceCode*/ ctx[3]);
    			}

    			if (dirty & /*errorSolutionCode*/ 16) {
    				set_input_value(textarea1, /*errorSolutionCode*/ ctx[4]);
    			}

    			if (dirty & /*lang*/ 32 && input1.value !== /*lang*/ ctx[5]) {
    				set_input_value(input1, /*lang*/ ctx[5]);
    			}

    			if (!current || dirty & /*isSubmitting*/ 2) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<CreatePost> was created with unknown prop '${key}'`);
    	});

    	function input0_input_handler() {
    		errorTitle = this.value;
    		$$invalidate(2, errorTitle);
    	}

    	function textarea0_input_handler() {
    		errorSourceCode = this.value;
    		$$invalidate(3, errorSourceCode);
    	}

    	function textarea1_input_handler() {
    		errorSolutionCode = this.value;
    		$$invalidate(4, errorSolutionCode);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('errorTitle' in $$props) $$invalidate(2, errorTitle = $$props.errorTitle);
    		if ('errorSourceCode' in $$props) $$invalidate(3, errorSourceCode = $$props.errorSourceCode);
    		if ('errorSolutionCode' in $$props) $$invalidate(4, errorSolutionCode = $$props.errorSolutionCode);
