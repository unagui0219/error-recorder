var app = (function () {
    ...
    /* webviews\components\ViewIndex.svelte generated by Svelte v3.49.0 */

    const file = "webviews\\components\\ViewIndex.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	let div0;
    	let h2;
    	let t0_value = /*user*/ ctx[1].title + "";
    	let t0;
    	let t1;
    	let p;
    	let span;
    	let t3_value = /*user*/ ctx[1].solution_code + "";
    	let t3;
    	let t4;
    	let div1;
    	let button0;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			span = element("span");
    			span.textContent = "解決策：";
    			t3 = text(t3_value);
    			t4 = space();
    			div1 = element("div");
    			button0 = element("button");
    			button0.textContent = "詳細を見る";
    			t6 = space();
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h1, file, 21, 4, 707);
    			add_location(hr, file, 22, 4, 740);
    			attr_dev(div, "class", "title-box svelte-5qhp2z");
    			add_location(div, file, 20, 0, 679);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots('ViewIndex', slots, []);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ViewIndex> was created with unknown prop '${key}'`);
    	});
    ...
    class ViewIndex extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
